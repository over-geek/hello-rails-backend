...
**Hello Rails BACK-END** holds the Backend development source rails api of an app that displays random greetings
...
[Hello React](https://github.com/over-geek/hello-react-front-end.git)
...
```sh
  git clone https://github.com/over-geek/hello-rails-backend.git
```
